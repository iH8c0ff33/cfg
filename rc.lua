...
tags = {
  names = { "1", "2", "3", "4", "5", "6" },
  layout = { layouts[1], layouts[2], layouts[3], layouts[2], layouts[2], layouts[1] }
}
...
awful.key({ modkey, "Shift"   }, "Return", function () awful.util.spawn(terminalf) end),
awful.key({ modkey, "Shift"   }, "s",      function () awful.util.spawn(homessh) end),
awful.key({ modkey, "Shift"   }, "f",      function () awful.util.spawn(filemanager) end),
awful.key({ modkey, "Shift"   }, "e",      function () awful.util.spawn(teditor) end),
awful.key({ modkey, "Shift"   }, "m",      function () awful.util.spawn(ncmpcpp) end),
